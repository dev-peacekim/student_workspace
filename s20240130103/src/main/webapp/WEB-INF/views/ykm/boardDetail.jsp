		...
		<form action="" >
			...
			<div class="row card card-body">
				...
				<div class="community-post-answer">
					...
					<form action="StudyPostComment" method="post">
						<input type="hidden" name="cboard_no" value="${renderPostContent.cboard_no}" />
						<input type="hidden" name="creply_no" value="" />
						
						<div class="comment-editor">
							<i class="bi bi-person-circle comment-user-profile" alt="유저 프로필"></i>
							<input type="text" name="creply_content" id="inputField"
								placeholder="id님, 댓글을 작성해보세요." class="form-control" required="">
						</div>
						<div class="btn-container">
							<button id="resetBtn" type="button" class="hidden btn btn-secondary">취소</button>
							<button id="submitBtn" type="submit" class="hidden btn btn-primary">등록</button>
						</div>
					</form>
				</div>
				<!-- 댓글 리스트 -->
				...
				<div class="reply-comment">
					<form action="ref-reply" method="get">
						...
						<div class="reply-body">
							<span class="reply-content">쪽지 남겨놓으면 될까요?</span>
