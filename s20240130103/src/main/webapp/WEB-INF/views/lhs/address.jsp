		...
		<h1>주소록</h1>
			<div class="maindiv">
				<div class="navigation d-flex align-items-center">
					<div>
						<button class="btn btn-outline-secondary navmargin">전체</button>
					    <button class="btn btn-outline-secondary navmargin">대기중</button>
					    <form action="" class="d-flex align-items-center ml-auto">
					        <input type="text" class="form-control width300 mr-2">
